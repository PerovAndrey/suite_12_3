...
class TournamentTest(unittest.TestCase):
    ...
    def test_turn4(self):
        ...
        turn_4 = Tournament(6, self.runer_1, self.runer_2, self.runer_3)
        result = turn_4.start()
        self.assertTrue(result[list(result.keys())[-1]] == 'Ник', 'Ошибка! Последним должен быть Ник')
...
run_tourST.addTest(unittest.TestLoader().loadTestsFromTestCase(RunnerTest))
run_tourST.addTest(unittest.TestLoader().loadTestsFromTestCase(TournamentTest))
